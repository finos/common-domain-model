...
In order to start working with Docusaurus, please read the [Getting Started guide](https://docusaurus.io/docs) and browse through the following folders and files:
