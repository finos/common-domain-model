...
export const featuresTwoHeader = [
    ...
    },
    {
        ...
        description: (
            ...
            <br />
            <br />
            <span style={{ fontSize: '1.25em' }}><strong>Benefits for Derivatives:</strong></span>
            <ul>
            ...
            <span style={{ fontSize: '1.25em' }}><strong>Benefits for Securities Lending:</strong></span>
            <ul>
            ...
            <span style={{ fontSize: '1.25em' }}><strong>Benefits for Bonds & Repos:</strong></span>
            <ul>
