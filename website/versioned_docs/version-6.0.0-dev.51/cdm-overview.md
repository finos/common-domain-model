...
[![FINOS - Incubating](https://cdn.jsdelivr.net/gh/finos/contrib-toolbox@master/images/badge-incubating.svg)](https://community.finos.org/docs/6.0.0-dev.51/governance/Software-Projects/stages/incubating)
...
-   **Model definition**, which corresponds to the model as expressed in
    ...
    [common-domain-model](/docs/6.0.0-dev.51/common-domain-model) of the
    documentation.
    -   Product
    -   Event
    -   Legal Agreement
...
[CDM Java Distribution Guidelines](/docs/6.0.0-dev.51/cdm-guidelines).
