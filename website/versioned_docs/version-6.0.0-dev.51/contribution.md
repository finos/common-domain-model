...
The Common Domain Model is an open standard project hosted under FINOS, the [Fintech Open Source Foundation](https://community.finos.org/docs/6.0.0-dev.51/governance/Standards-Projects), starting in February 2023.

The standard is developed through the [Community Specification](https://community.finos.org/docs/6.0.0-dev.51/governance/#open-standard-projects) open governance process, and underlying code assets are released under the [Community Specification License 1.0](https://github.com/finos/standards-project-blueprint/blob/master/governance-documents/4._License.md). For versions before 4.0.0 and other license details, check [Notice.md](https://github.com/finos/common-domain-model/blob/master/NOTICE.md).
...
CDM [design-principles](/docs/6.0.0-dev.51/cdm-overview#design-principles) and
[agile-development-approach](/docs/6.0.0-dev.51/cdm-overview#agile-development-approach) and submitted
...
-   Review the [design-principles](/docs/6.0.0-dev.51/cdm-overview#design-principles) and
    [governance](/docs/6.0.0-dev.51/cdm-overview#governance)
...
[agile-development-approach](/docs/6.0.0-dev.51/cdm-overview#agile-development-approach) and follows
these steps:
...
Please refer to the [namespace-documentation](/docs/6.0.0-dev.51/namespace) section for more details.
...
CDM](/docs/6.0.0-dev.51/cdm-overview) section at the beginning of the user
...
1.  *Financial Product*. The user documentation defines
    [financial-product](/docs/6.0.0-dev.51/product-model#financial-product) as the highest
...
2.  *Contractual Product*. Similarly,
    [contractual-product](/docs/6.0.0-dev.51/product-model#contractual-product) is defined as a
...
1.  *Business Event*. In the CDM, a [business-event](/docs/6.0.0-dev.51/event-model#business-event) represents an event that may occur during the lifecycle
    ...
    1.  Not *Lifecycle Event*. the term *Business Event* should be
        ...
        CDM documentation.
2.  *Primitive Event*. In the CDM, a [primitive-event](/docs/6.0.0-dev.51/event-model#primitive-event) represents a building block component used to specify
...
|:--------------|:----------------------------------:|--------------------------------------:|---------------------------------------------------------:|
| 1             |        _[===============]_         |                      XL font and bold |         [common-domain-model](/docs/6.0.0-dev.51/common-domain-model) |
| 2             | _[\-\-\-\-\-\-\-\-\-\-\-\-\-\--]_  |                       L font and bold |               [product-model-page](/docs/6.0.0-dev.51/product-model),<br/>[legal-agreements-page](/docs/6.0.0-dev.51/legal-agreements) |
| 3             | _[\^\^\^\^\^\^\^\^\^\^\^\^\^\^\^]_ |                       M font and bold | [tradable-product](/docs/6.0.0-dev.51/product-model#tradable-product) |
| 4             | _["""""""""""""""]_ |     S font (same ascontent), but bold |     [price-quantity](/docs/6.0.0-dev.51/product-model#price-quantity) |
:Heading Styles
