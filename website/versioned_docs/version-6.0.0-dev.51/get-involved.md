...
Finally, another great way to interact with the community is to attend the bi-weekly [ Contribution Review Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Contribution-Review-WG), monthly [Collateral Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Collateral-WG), monthly [FINOS  Structured Products Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Structured-Products-WG), monthly [Steering Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Steering-WG), monthly [Technology Architecture Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Technology-Architecture-WG), bi-weekly [Derivative Products and Business Events Working Group](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Derivative-Products-and-Business-Events-WG), and/or quarterly [Steering Working](https://cdm.finos.org/docs/6.0.0-dev.51/CDM-Steering-WG) Group: email help@finos.org to be added to the meeting invites directly, or find the meeting in the [FINOS Community Calendar](https://calendar.google.com/calendar/embed?src=finos.org_fac8mo1rfc6ehscg0d80fi8jig%40group.calendar.google.com). 
