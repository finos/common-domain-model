...
[event-model-section](/docs/6.0.0-dev.51/event-model) provides a
...
-   The constructed events qualify according to the qualification logic
    described in the [event-qualification-section](/docs/6.0.0-dev.51/event-model#event-qualification-section).
