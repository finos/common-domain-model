...
public abstract class CounterpartyOrRelatedPartyMappingProcessor extends MappingProcessor {
	...
	public CounterpartyOrRelatedPartyMappingProcessor(RosettaPath modelPath, List<Path> synonymPaths, MappingContext context, RelatedPartyRoleEnum relatedPartyEnum) {
