...
public class AgreementPartyMappingProcessor  extends MappingProcessor {

	public AgreementPartyMappingProcessor(RosettaPath modelPath, List<Path> synonymPaths, MappingContext context) {
