...
public class ClearingUtils {
	...
	static WorkflowStep buildRejectStep(PostProcessorRunner runner, WorkflowStep previous, String externalReference, IdentifierService identifierService) {
	...
	static WorkflowStep buildProposeStep(PostProcessorRunner runner, WorkflowStep previous, String externalReference, IdentifierService identifierService) {
		WorkflowStep.WorkflowStepBuilder stepBuilder = WorkflowStep.builder();
		stepBuilder
			.setPreviousWorkflowStep(ReferenceWithMetaWorkflowStep.builder()
				.setGlobalReference(previous.getMeta().getGlobalKey()).build())
			.setProposedInstruction(WorkflowStepInstruction.builder()
				.setInstructionFunction("Clear")
				.setInstruction(BusinessEventInstruction.builder()
	...
	static WorkflowStep buildClear(PostProcessorRunner runner, Contract contract, String externalReference, WorkflowStep previous, ClearingInstruction clearingInstruction, Clear clear, IdentifierService identifierService) {

		BusinessEvent.BusinessEventBuilder businessEventBuilder = clear.evaluate(contract, clearingInstruction).toBuilder();
	...
	static WorkflowStep buildContractFormationStep(PostProcessorRunner runner, Contract contract, String externalReference, IdentifierService identifierService) {
		WorkflowStep.WorkflowStepBuilder stepBuilder = WorkflowStep.builder();
