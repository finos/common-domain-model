...
public class DefaultRosettaHashFunction implements RosettaHashFunction<Integer> {
    ...
    @Override
    public <U extends RosettaModelObject> Integer hash(U modelObject) {
        return modelObject.externalHash(this);
    }
