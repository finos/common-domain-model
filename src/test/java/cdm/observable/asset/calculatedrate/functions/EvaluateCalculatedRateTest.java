...
public class EvaluateCalculatedRateTest extends AbstractFunctionTest {
    ...
    private double averageRate(List<? extends BigDecimal> observations, List<Integer> weights) {
        double sum = 0.0;
        double sumWts = 0.0;
    ...
    private double compoundRate(List<? extends BigDecimal> observations, List<Integer> weights, double basis) {
        double prod = 1.0;
        double sumWts = 0.0;
        for (int i = 0; i < observations.size(); i++)  {
