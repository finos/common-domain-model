...
//    private static RetrieveBusinessCenterHolidaysImplTest tester;
    ...
    void shouldGetResult() {
        ...
        assertEquals(Boolean.FALSE, func.evaluate(DateImpl.of(2021,12, 20), londonTargetBC));
        assertEquals(Boolean.FALSE, func.evaluate(DateImpl.of(2021,12, 19), londonTargetBC));
        assertEquals(Boolean.TRUE, func.evaluate(DateImpl.of(2021,12, 27), londonTargetBC));
        assertEquals(Boolean.TRUE, func.evaluate(DateImpl.of(2021,12, 28), londonTargetBC));
        assertEquals(Boolean.FALSE, func.evaluate(DateImpl.of(2021,12, 27), targetBC));
