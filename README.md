...
#### You can do so by first subscribing at [cdm-maintainers+subscribe@lists.finos.org](cdm-maintainers+subscribe@lists.finos.org) and posting at [cdm-maintainers@lists.finos.org](cdm-maintainers@lists.finos.org). 
