...
The Weight and Observable for each BasketConstituent can be represented through the PriceQuantity element in the model, with the addition of a `Weight` financial unit enumeration.
