...
# *Ingestion Framework for FpML - Mapping Coverage: Events*
...
This release maps Events, as per [#4272](https://github.com/finos/common-domain-model/issues/4272).

Updates to mapping of FpML events:

- `EconomicTerms` attributes `nonStandardisedTerms`

_Review Directions_

Changes can be reviewed in PR: [#4372](https://github.com/finos/common-domain-model/pull/4372)
