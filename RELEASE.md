...
This release also updates the FpML / ISO code scheme syncing configuration to exact matching allowing backward-incompatible changes, as per the [development version guidelines](https://cdm.finos.org/docs/dev-guidelines/#backward-compatibility).
