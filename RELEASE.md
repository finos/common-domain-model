...
Replacing the securityProvider attribute option of string with the CounterpartyRoleEnum. This will offer the clarity for identifying party1 or party2. It is also recommended to change the cardinality to (1..2). This allows for both parties to be identified as well as individually.
