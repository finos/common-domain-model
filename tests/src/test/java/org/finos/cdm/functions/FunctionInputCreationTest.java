...
class FunctionInputCreationTest {
    ...
    @Test
    void testContractFormationOisSwapFuncInput() throws IOException {
        assertResult(creator.getContractFormationOisSwapFuncInputJson());
    }

    @Test
    void testContractFormationFxForwardFuncInput() throws IOException {
        assertResult(creator.
                getContractFormationFxForwardFuncInputJson());
    }

    @Test
    void testIncreaseEquitySwapExistingTradeLotFuncInput() throws IOException {
        assertResult(creator.getIncreaseEquitySwapExistingTradeLotFuncInputJson());
    }
