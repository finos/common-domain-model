...
The JSON snippet below for a quantity change event on a contract illustrates the use of multiple metadata reference (aka "hash") values in ``eventEffect``:
