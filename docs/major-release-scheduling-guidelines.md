...
* Breaking changes (as defined in the [change control guidelines](change-control-guidelines.md/#backwards-compatibility)) can only be implemented in a major version
