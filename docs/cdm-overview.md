...
ISDA has also launched Get Started guides for the CDM for Collateral and Digital Regulatory Reporting.  You can access these [here](https://www.isda.org/isda-solutions-infohub/cdm/).
...
A diagram outlining the groups involved can be found [here](cdm-org-structure.md)
...
![](/website/static/img/cdm-components-diagram.png)
...
-   **Model definition**, which corresponds to the model as expressed in
    ...
    [common domain model section](common-domain-model.md) of the
    documentation.
    -   Product
    -   Event
    -   Legal Agreement
