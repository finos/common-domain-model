...
* Additional Maintainers may be proposed by [Participants](https://github.com/igallizugaro/common-domain-model/blob/patch-28/Participants.md). Proposed new Private individuals or new organisations will be approved via consensus of the Participants and with agreement of existing Maintainers, and should meet the following criteria:
