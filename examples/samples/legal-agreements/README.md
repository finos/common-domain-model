...
## Scope
This project provides various sets of Legal Agreements examples based on dummy-generated ISDA CSA documents. It covers several versions of each document covering all the possible clause outcomes, including eligible collateral schedules. The document sets include 1994/1995 Legacy CSAs, VM and IM publications documents published between 2016 – 2019. This gives full coverage of the most commonly negotiated ISDA CSA documents. There is additional sets of stand-alone eligible collateral schedules. It is intended for the user to extract and download the versions they desire from a relevant marked folder based on the document type or schedule type. 
